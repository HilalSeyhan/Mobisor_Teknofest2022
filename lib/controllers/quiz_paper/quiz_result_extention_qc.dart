...
extension QuizeResult on QuizController {
  ...
  String get correctAnsweredQuestions {
    return '${allQuestions.length} soruda $correctQuestionCount başarılı! ';
  }
  ...
  Future<void> saveQuizResults() async {
    ...
    Get.find<NotificationService>().showQuizCompletedNotification(
        ...
        body:  'Tebrikler! ${quizPaperModel.title} yarışmasından tam tamına $points puan topladın.  -  Skor listesini görmek için tıkla' ,
